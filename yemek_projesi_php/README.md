...
| :--- | :--- |
| **Yemekler Tablosu:** Yemek adı, detayları ve görsel yollarını saklar. | ![Yemekler Tablosu](image/yemek.png) |
| **Malzemeler Tablosu:** Sistemdeki tüm tanımlı malzeme listesini saklar. | ![Malzemeler Tablosu](image/malzemeler.png) |
| **Yemek-Malzeme (Ara Tablo):** Yemekler ve malzemeler arasındaki bağı ve miktarları saklar. | ![Ara Tablo](image/aratablo.png) |
